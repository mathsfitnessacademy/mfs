        ...
        <div className={styles.container}>
            ...
            <div className={styles.card}>
                ...
                <div className={styles.weekly}>
                    ...
                    <Link href='/tool#eva' passHref><button className={styles.button}>Read More</button></Link>
                </div>
            </div>
            <div className={styles.card}>
                <div className={styles.daily}>
                    ...
                    <Link href='/tool#prac' passHref><button className={styles.button}>Read More</button></Link>                  
                </div>
